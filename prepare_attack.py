...
prepare_attack("results/T5/mnli/matched/correct_predictions.npy", 'T5', name='matched_attack_data')
prepare_attack("results/T5/mnli/mismatched/custom_correct_predictions.npy", 'T5', name='mismatched_attack_data')
